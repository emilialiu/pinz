function graphTrace(options) {
    ...
    // 获取图片资源
    var imageUrl = rootpath + "/manager/activity/view.action?bean.id=" + opts.pid + "&type=image";
    $.getJSON(rootpath + '/manager/activity/trace.action?bean.id=' + opts.pid, function(infos) {
