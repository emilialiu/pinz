...
CommonPerson.Base.LoadingPic = {
    operation: {
        ...
        loadingImgUrl: "../../style/images/waiting.gif",  //默认load图地址
    ...
    FullScreenShow: function (msg) {
        ...
        if (this.operation.loadingCount < 1) {
            this.operation.timeTest = setTimeout(function () {
                ...
                $("#loadingPage_bg").height($(top.window.document).height()-400).width($(top.window.document).width());
            }, 100);
        }
