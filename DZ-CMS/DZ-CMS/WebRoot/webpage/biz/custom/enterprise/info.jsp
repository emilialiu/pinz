...
<div id="dz_custom_enterprise_info" >
	<form id="dz_custom_enterprise_form" action="<%=request.getContextPath()%>/webpage/biz/custom/enterprise/doAddSave.action" method="post" class="form-horizontal">
		<input type="hidden" id="id" name="id" value="${bean.id}"/>
			...
			<div class="form-group">
				<label class="control-label col-xs-12 col-sm-3 no-padding-right"
					for="description">团购意向</label>
				<div class="col-xs-12 col-sm-9">
					<div class="col-sm-6">
						<!-- class="clearfix" -->
						<textarea name="description" id="description" class="col-xs-12"></textarea>
					</div>
					<div class="col-sm-3"></div>
				</div>
			</div>
			...
			<div class="form-group">
				<label class="control-label col-xs-12 col-sm-3 no-padding-right"
					for="demand_count">需求数量</label>
				<div class="col-xs-12 col-sm-9">
					<div class="col-sm-6">
						<!-- class="clearfix" -->
								 <dmtag:sourcemanager sourcename="XQSL" name="demand_count" cssClass="form-control"
							fixValue="${bean.demand_count}"></dmtag:sourcemanager>
					</div>
					<div class="col-sm-3"></div>
				</div>
			</div>
					...
					<div class="col-sm-6">
						...
						<div class="input-group">
							<input type="text" name="create_time" id="create_time"
								...
								onfocus="WdatePicker({dateFmt:'yyyy-MM-dd mm:HH:ss'})" /><span
		...
		<%-- 	<div class="form-group">
				<label class="control-label col-xs-12 col-sm-3 no-padding-right"
					for="customer_id">定制客户id</label>
				<div class="col-xs-12 col-sm-9">
					<div class="col-sm-6">
						<!-- class="clearfix" -->
						<input type="text" name="customer_id" id="customer_id"
							value="${bean.customer_id}" class="col-xs-12" />
					</div>
					<div class="col-sm-3"></div>
				</div>
			</div> --%>
			<div class="form-group">
				<label class="control-label col-xs-12 col-sm-3 no-padding-right"
					for="state">处理状态</label>
				<div class="col-xs-12 col-sm-9">
					<div class="col-sm-6">
						<!-- class="clearfix" -->
						 <dmtag:sourcemanager sourcename="CLZT" name="state" cssClass="form-control"
							fixValue="${bean.state}"></dmtag:sourcemanager>
					</div>
					<div class="col-sm-3"></div>
				</div>
			</div>
