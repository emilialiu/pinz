var addsaveurl = rootpath+"/webpage/biz/linear/number/doAddSave.action";
var modifysaveurl = rootpath+"/webpage/biz/linear/number/doModifySave.action";
var deletesaveurl = rootpath+"/webpage/biz/linear/number/delete.action";
...
function setInfoData(_bizname,data){  
	...
	consoleDlg.find("#coefficient").val(rowData.coefficient);
...
function getInfoData(_bizname){
	...
	var coefficient = $.trim(consoleDlg.find("#coefficient").val());
