		...
		<div class="row">
			<div class="col-xs-12">
				...
				<div class="input-group col-sm-8">
					...
					<input type="text" id="t_bi_mrbaseinfofee_text_search" class="form-control search-query" placeholder="" />
					<span class="input-group-btn">
						<button id="t_bi_mrbaseinfofee_btn_search" type="button" class="btn btn-purple btn-sm">
							<span class="ace-icon fa fa-search icon-on-right bigger-110"></span>&nbsp;&nbsp;
							查询
						</button>
						<button id="t_bi_mrbaseinfofee_btn_advsearch" style="margin-left:10px;" class="btn btn-pink btn-sm">
...
<script type="text/javascript" src="<%=request.getContextPath()%>/webpage/biz/bi/mrbaseinfofee/bizgrid.js"></script>
</html>