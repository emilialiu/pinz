$(function() {
	...
	$("#dz_coupon_user_record_grid").data("gridOptions", {
		...
		colModel : [ //	align:left,center,right,默认left;classes:列的css;datefmt:默认Y-m-d;defval:查询字段的默认值;editable:单元格是否可编辑,默认false;
					...
					{name : 'processbtn',index:'', width:80, fixed:true, sortable:false, resize:false,search : false,hidden : true},
						...
						{name : 'state',index : 'state',fixed : true,width : 100,sorttype : 'int(11)',editable : false,hidden : true,searchoptions : {sopt : [ 'cn', 'eq', 'ne', 'le', 'lt', 'gt', 'ge' ]}},
						{name : 'stateName',index : 'stateName',fixed : true,width : 100,sorttype : 'varchar(4)',editable : false,searchoptions : {sopt : [ 'cn', 'eq', 'ne', 'le', 'lt', 'gt', 'ge' ]}},
