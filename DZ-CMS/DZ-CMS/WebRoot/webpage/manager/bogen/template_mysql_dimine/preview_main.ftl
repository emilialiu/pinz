			...
			<div class="col-xs-12">
				...
				<div class="input-group col-sm-8">
					...
					<span class="input-group-btn">
						<button onclick="alert('查询成功!')" type="button" class="btn btn-purple btn-sm">
							<span class="ace-icon fa fa-search icon-on-right bigger-110"></span>&nbsp;&nbsp;
							查询
						</button>
						<button onclick="alert('高级查询成功!')" style="margin-left:10px;" class="btn btn-pink btn-sm">
...
<script type="text/javascript" src="<%=request.getContextPath()%>/${previewPath ?lower_case}/bizgrid.js"></script>
