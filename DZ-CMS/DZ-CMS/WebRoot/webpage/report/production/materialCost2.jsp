...
<div class="row">
	<div class="col-xs-12">
		...
		<form id="reportforms_materialCost" action="<%=request.getContextPath()%>/pub/report/doReport.action" target="reportframe" >
			<input type="hidden" name="reportclass" value="material_cost2"/>
...
<script type="text/javascript" src="<%=request.getContextPath()%>/webpage/report/production/tree2.js"></script>
