...
<html>
	...
	<body style="background-color: #fff">
		<div class="row">
			<div class="col-xs-12">
				...
				<div class="input-group col-sm-8">
					...
					<input type="text" id="dz_commodity_base_text_search" class="form-control search-query" placeholder="商品名称" />
			...
			<div class="col-xs-12">				
				<div id="dz_commodity_base_grid_box" class="widget-box widget-color-blue">
					<div class="widget-header">
						<h5 class="widget-title"><i class="ace-icon fa fa-list"></i>商品信息</h5>
		...
		<script type="text/javascript">
			...
			var multiselect = <%=request.getAttribute("multiselect")%>
		</script>
