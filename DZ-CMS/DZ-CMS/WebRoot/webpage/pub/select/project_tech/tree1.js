	...
	function getTreeNodes_weifenpei(node) {
		...
		$.ajax({
			url: rootpath+'/biz/bi/technologyProject/rolepopedomunlist.action',
			data: {'bean.projectid':node.id, 'bean.techid':techid, 'bean.projectname':$("#projectname").val(), 'bean.projecttype':$("#projecttype").val()},
			cache: false,
