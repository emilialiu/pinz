...
<html>
	...
	<body style="background-color: #fff">
				...
				<div class="col-sm-4">
					<div class="widget-box widget-color-blue">
						<div class="widget-header">
							<h4 class="widget-title lighter smaller"><i class="ace-icon fa fa-sitemap"></i>设备类型树</h4>
						</div>
		...
		<script type="text/javascript">
			var root = [{"id":"0000", "dtid":"", "name":"所有设备", "isParent":"true", "close":"true"}];<%--  <%= "["+(String) request.getAttribute("jsonString")+"]"%>; --%>
			...
			function onSave() {
				...
				try{
					parent.PageObject.itemMap['selectdevicetype'].callback(no);
				}catch(e){
					parent.closewin('selectdevicetype');
				}
				parent.closewin('selectdevicetype');
			}
			
			function uncheck() {
				parent.PageObject.itemMap['selectdevicetype'].callback([]);
				parent.closewin('selectdevicetype');
			};
		</script>
	</body>
