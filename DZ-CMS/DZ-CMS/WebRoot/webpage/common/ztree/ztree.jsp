...
<script type="text/javascript"
	src="<%=request.getContextPath()%>/common/ztree/tree.js"></script>
	...
	<div class="col-xs-12 col-sm-6 widget-container-col">
		...
		<div class="widget-box widget-color-blue">
			<div class="widget-header">
				<h5 class="widget-title">ztree使用方法</h5>
			...
			<div class="widget-body">
				<div class="widget-main">
					...
					<p class="alert alert-success">
						1、界面引入
						<br/>
						"/style/jquery/botree.css"和"/js/jquery/botree.js"、"/common/ztree/tree.js"
						<br/>
						2、代码部分:
						<br/>
						&lt;dmtag:ztreemanager name="mine_tree" table="T_ztree" ztreevalue="id"
