...
public class Dz_commodity_baseAction extends BaseAction {
	...
	@Action(value = "insertjson", results = { @Result(name = "success", location = "/webpage/pub/beanresult.jsp") })
	public String insertjson(){
		try {
			dz_commodity_baseService.insertjson(bean);
		} catch (Exception e) {
	...
	@Action(value = "updatejson", results = { @Result(name = "success", location = "/webpage/pub/beanresult.jsp") })
	public String updatejson(){
		try {
			dz_commodity_baseService.updatejson(bean);
		} catch (Exception e) {
			// TODO Auto-generated catch block
			e.printStackTrace();
		}
