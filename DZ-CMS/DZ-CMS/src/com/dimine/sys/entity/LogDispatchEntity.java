...
public class LogDispatchEntity extends BaseEntity
{

	public static final String IBATIS_KEY_EXPORT_LIST = "LogDispatchEntity.export.list";
	public static final String IBATIS_KEY_INSERT = "LogDispatchEntity.insert";
