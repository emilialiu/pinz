...
public class LogExceptionEntity extends BaseEntity
{
	...
	public static final String IBATIS_KEY_EXPORT_LIST = "LogExceptionEntity.export.list";
	public static final String IBATIS_KEY_INSERT = "LogExceptionEntity.insert";
	...
	public String getExceptionmodule() {
		return exceptionmodule;
	}

	public void setExceptionmodule(String exceptionmodule) {
