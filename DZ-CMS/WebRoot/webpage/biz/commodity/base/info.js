...
function getInfoData(_bizname){
	...
	var is_hot_money = $.trim(consoleDlg.find("#is_hot_money").val());
	var is_new_product = $.trim(consoleDlg.find("#is_new_product").val());
	var is_recommend = $.trim(consoleDlg.find("#is_recommend").val());
