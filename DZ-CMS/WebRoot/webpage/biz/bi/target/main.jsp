		...
		<div class="row">
			<div class="col-xs-12">
				...
				<div class="input-group col-sm-8">
					...
					<input type="text" id="t_bi_target_text_search" class="form-control search-query" placeholder="" />
					<span class="input-group-btn">
						<button id="t_bi_target_btn_search" type="button" class="btn btn-purple btn-sm">
							<span class="ace-icon fa fa-search icon-on-right bigger-110"></span>&nbsp;&nbsp;
							查询
						</button>
						<button id="t_bi_target_btn_advsearch" style="margin-left:10px;" class="btn btn-pink btn-sm">
			...
			<div class="col-xs-12">				
				<div id="t_bi_target_grid_box" class="widget-box widget-color-blue">
					<div class="widget-header">
						<h5 class="widget-title"><i class="ace-icon fa fa-list"></i>指标信息</h5>
...
<script type="text/javascript" src="<%=request.getContextPath()%>/webpage/biz/bi/target/bizgrid.js"></script>
