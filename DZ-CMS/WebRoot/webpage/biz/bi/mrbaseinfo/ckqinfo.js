...
function getInfoData(_bizname){
    ...
    return {   
        ...
        "bean.remark" : remark,
        "ckqbean.cooperateent" : cooperateent,
        "ckqbean.planscale" : planscale,
        "ckqbean.involume" : involume,
        "ckqbean.arearange" : arearange,
        "ckqbean.mrarea" : mrarea,
        "ckqbean.mineraltype" : mineraltype,
        "ckqbean.catype" : catype,
        "ckqbean.verifyreserve" : verifyreserve,
        "ckqbean.mineway" : mineway,
        "ckqbean.miningmethod" : miningmethod,
        "ckqbean.benemethod" : benemethod,
        "ckqbean.depthupper" : depthupper,
        "ckqbean.depthlower" : depthlower,
        "ckqbean.minegetway" : minegetway
    };      
}
//根据后台数据，拼装grid行数据
