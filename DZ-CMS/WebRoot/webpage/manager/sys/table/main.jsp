...
<div class="row">
	<div class="col-xs-12">
		...
		<script type="text/javascript">
			var $path_base = "<%=request.getContextPath()%>";//in Ace demo this will be used for editurl parameter
		</script>
...
<script type="text/javascript">
	var scripts = [null,"<%=request.getContextPath()%>/assets/js/date-time/bootstrap-datepicker.min.js","<%=request.getContextPath()%>/assets/js/jqgrid/jquery.jqgrid.min.js","<%=request.getContextPath()%>/assets/js/jqgrid/i18n/grid.locale-cn.js", null]
