...
<html>
	<head>
		<title><s:text name="dmmes.sc.devtechprocess.select" /></title>
	...
	<body style="background-color: #fff">
		<div class="row" style="padding:0 10px 10px 10px"">
			<div class="col-xs-12">
				...
				<div class="input-group col-sm-10">
					...
					<input type="text" id="device_text_search" class="form-control search-query"  placeholder="<s:text name="dmmes.dm.deviceteam.devcode" />，<s:text name="dmmes.dm.deviceteam.devnamename" />" />
					<span class="input-group-btn">
						<button id="device_btn_search" type="button" class="btn btn-primary btn-sm">
							<span class="ace-icon fa fa-search icon-on-right bigger-110"></span>&nbsp;&nbsp;
							<s:text name="button.query" />
						</button>
						<button id="device_btn_advsearch" style="margin-left:10px;" class="btn btn-primary btn-sm">
				...
				<div class="col-xs-12" style="padding:0 2px 0 2px">
					<div id="device_grid_box" class="widget-box widget-color-blue">
					<div class="widget-header">
						<h5 class="widget-title"><i class="ace-icon fa fa-list"></i><s:text name="dmmes.sc.devtechprocess.select" /></h5>
						<div class="widget-toolbar">
							<a href="#" data-action="fullscreen" class="orange2">
								<i class="ace-icon fa fa-expand"></i>
							</a>
							<a href="#" id="device_grid_box_filter" data-action="filter">
		...
		<script type="text/javascript" src="<%=request.getContextPath()%>/webpage/pub/select/processdevice/bizgrid.js"></script>
	</body>
</html>
