function loadGrid(deptid) {
	...
	$("#staff_grid").data("gridOptions", {
		height : 272,
		url :  rootpath + '/biz/sm/staff/list.action?bean.deptid='+deptid,
		colNames : [ 
					//'操作',
					'员工ID',
					'部门id',
...
function dosearchbydept(deptID){
	...
	$("#staff_grid").jqGrid('setGridParam',{url:rootpath + "/biz/sm/staff/list.action?bean.deptid="+deptID}).trigger("reloadGrid");
}
