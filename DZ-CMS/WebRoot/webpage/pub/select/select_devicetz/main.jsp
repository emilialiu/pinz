...
<html>
	...
	<body style="background-color: #fff">
			...
			<div class="col-xs-12">
				...
				<div class="col-xs-12" style="padding:0 2px 0 2px">
					...
					<div class="widget-header">
						<h5 class="widget-title"><i class="ace-icon fa fa-list"></i><s:text name="dmmes.dm.deviceteam.deviceselection" /></h5>
		...
		<script type="text/javascript">
			...
			var devkind = "<%=request.getParameter("devkind")%>";
			if(devkind=='null'){
				devkind="";
			}
			var devstatus = "<%=request.getParameter("devstatus")%>";
			if(devstatus=='null'){
				devstatus="";
			}
			var devtype = "<%=request.getParameter("devtype")%>";
			if(devtype=='null'){
				devtype="";
			}
		</script>
