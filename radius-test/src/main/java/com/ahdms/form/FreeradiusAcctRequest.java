package com.ahdms.form;

import com.ahdms.util.DateTimeUtil;
...
public class FreeradiusAcctRequest {
	...
	public FreeradiusAcctRequest(String username, String nasip, String nasid, String macAddr, String nasPortId,
			String framedIPAddress, String acctSessionId, Integer acctSessionTime, Integer sessionTimeout,
			String framedIPNetmask, Long acctInputOctets, Long acctOutputOctets, Long acctInputGigawords,
			Long acctOutputGigawords, Integer acctInputPackets, Integer acctOutputPackets, String acctStatusType) {
		super();
		this.username = username;
		this.nasip = nasip;
		this.nasid = nasid;
